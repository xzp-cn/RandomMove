...
namespace huang.module.ui.settingui
{
    public class UISetting : MonoBehaviour
    {
        ...
        private void Start()
        {
            InvokeRepeating("UpdateCheck", 1f,2);
        }
        ...
        void Awake()
        {
            ...
            screenNum = liu.GetScreenMode.GetSreenNum();
            ...
            if (screenNum > 1 && projectionState != 2)
            {
                ...
                Debug.Log("UISetting.Awake(): 开启扩展模式" + projectionState);
        ...
        void JudgeMoreThanTwoScreen()
        {
            ...
            //一开始有两屏幕，后面段了一个屏幕
            //一开始有一个屏幕，后面加了一个屏幕
            if (liu.GetScreenMode.GetSreenNum() < 2)
            {
        ...
        //public CloseUnuseProjectionCamera closeUnuseProjectionCamera;
